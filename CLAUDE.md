...
| 5 Build | in progress — `docs/build-plan.md` §1 ground checklist closed 2026-08-20; deployed to **https://plot-steel.vercel.app**; slice 0 (`ground`) merged 2026-08-21, slice 1 (`address`) next |
