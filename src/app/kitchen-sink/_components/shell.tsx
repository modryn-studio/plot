 ...
 * one that is current.)
 *
 * NO LITERAL VALUES, same as every other file under this route. The scrim is bg-bg/60: the page's
 * own ground at 60%, which washes the right direction in both modes without needing a scrim token.
 *
    ...
    <div className="flex h-dvh overflow-clip">
      ...
      <div
        ...
        className={cn(
          ...
          'bg-bg/60 fixed inset-0 z-40 backdrop-blur-sm transition-opacity ease-out md:hidden',
