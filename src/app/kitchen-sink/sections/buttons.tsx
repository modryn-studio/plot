  ...
  return (
    ...
    >
      ...
      <Row label="Long label" note="truncates to one ellipsis, never escapes the box">
        ...
        <Note>
          It TRUNCATES rather than wrapping, and that follows from the stated-height rule above
          rather than overriding it: a button whose height is declared cannot grow to hold a second
          line, so a wrapping label escapes the box instead. Measured before the fix, at a 200px
          width this label needed 50px inside a 40px button. Narrow the window to watch the ellipsis
          arrive rather than the text spill.
        </Note>
      </Row>
    </Section>
  );
