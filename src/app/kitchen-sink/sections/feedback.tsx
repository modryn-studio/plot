    ...
    >
      ...
      <Row label="Skeleton on a Card" note="the ground it is actually used on, not the page">
        ...
        <Note>
          ...
          far more often than on the page, and the two grounds are different. Checking a placeholder
          against the one surface it is never used on is how a real failure survives review:
          run-rebuild aliases `elevated` to `surface`, so this component ported verbatim became the
          exact colour of the Card it sat in and did not render at all, while looking correct on the
          page directly above. Both rows, both modes, every time.
        </Note>
      </Row>
