...
export function CodeInput({
   ...
   * so there is nothing to look unfocused: the user sees six empty boxes, types into the void, and
   ...
   * exactly one meaning - the user may now type - so taking focus is never wrong. Guarding on the
